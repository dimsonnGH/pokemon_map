...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey('Pokemon', on_delete=models.SET_NULL, null=True, blank=True, related_name='next_evolution', verbose_name='эволюционировал из')
